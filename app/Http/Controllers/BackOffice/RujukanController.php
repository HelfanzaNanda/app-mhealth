...
class UsersController extends BackOfficeController
{
	public function datatables(){
		...
		$datatables = datatables($data)
			->addColumn('_buttons',function($row){
				$editurl = route('backoffice.rujukan.edit',$row->id);
	...
	public function edit($id){
		...
		$data->password='';
		return view('backoffice.rujukan.form',['title'=>"Edit - {$data->name}",'data'=>$data]);
	}
	public function insert(){
		return view('backoffice.rujukan.form',['title'=>'Insert','data'=>[
			'id'=>'',
			'name'=>'',
			'email'=>'',
			'password'=>'',
