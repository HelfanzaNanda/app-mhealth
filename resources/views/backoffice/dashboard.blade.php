          ...
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6 col-md-12 col-xl-5">
                <h3 class="mb-2">@{{homeData.customerTotal}}</h3>
      ...
      <div class="col-md-4 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            ...
            <div class="row">
              <div class="col-6 col-md-12 col-xl-5">
                <h3 class="mb-2">@{{homeData.onprocessOrder}}</h3>
                <div class="d-flex align-items-baseline">
                  <!-- <p class="text-danger"> -->
                    <span>Total @{{homeData.totalOrder}} orders</span>
...
<div class="row">
  ...
  <div class="col-lg-5 col-xl-4 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        <div class="d-flex justify-content-between align-items-baseline mb-2">
          <h6 class="card-title mb-0">Top 10 Popular Product</h6>
        ...
        <div class="table-responsive">
          <table class="table table-hover mb-0">
            ...
            <tbody>
              <tr v-for="(row,idx) in homeData.popularProduct">
                <td>@{{idx+1}}</td>
                <td>@{{row.name}}</td>
                <td>@{{row.rating}}</td>
              </tr>
          ...
          <table class="table table-hover mb-0">
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="border-bottom">WhatsappGateway EmberJs</td>
