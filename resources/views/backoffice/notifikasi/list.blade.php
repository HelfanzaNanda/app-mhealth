    ...
    <div class="card-header">
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        ...
        <div class="d-flex align-items-center flex-wrap text-nowrap">
          ...
          <a class="btn btn-sm btn-primary mb-2 mb-md-0" href="{{route('backoffice.notifikasi.insert')}}">
    ...
    <div class="card-body">
      <div class="mb-2">
        <div class="table-responsive py-1" style="min-height: 50vh">
          ...
          'url'=>route('backoffice.notifikasi.datatables'),
          'columns'=>[
          'fullname'=>'<th>User</th>',
...
<script type="text/javascript">
  function Delete(id) {
    let url = "{{ route('backoffice.notifikasi.delete', '')}}"+"/"+id;
    Swal.fire({
        title: 'Are you sure ?',
