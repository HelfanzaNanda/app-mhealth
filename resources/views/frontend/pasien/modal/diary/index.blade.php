    ...
    <div class="container-mhealth ">
        <form action="" id="diary_form">
            ...
            <div class="form-group">
                ...
                <input type="text" required name="info1" id="info1" class="form-control font-size-16 form-mhealth"
                    value="{{ $data->info1 ?? '' }}">
            </div>
            <div class="form-group">
                <label class="font-weight-500">Apa yang ibu makan dan minum hari ini ?</label>
                <input type="text" required name="info2" id="info2" class="form-control font-size-16 form-mhealth"
                    value="{{ $data->info2 ?? '' }}">
            </div>
            <div class="form-group">
                <label class="font-weight-500">Apakah ibu sudah minum obat / vitamin hari ini ?</label>
                <input type="text" required name="info3" id="info3" class="form-control font-size-16 form-mhealth"
                    value="{{ $data->info3 ?? '' }}">
            </div>
            <div class="form-group">
                <label class="font-weight-500">Bagaimana kondisi janin ibu hari ini ?</label>
                <input type="text" required name="info4" id="info4" class="form-control font-size-16 form-mhealth"
                    value="{{ $data->info4 ?? '' }}">
            </div>
