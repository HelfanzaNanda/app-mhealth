        ...
        <div class="container-mhealth pt-2">
            <form id="form-edit">
                ...
                <div class="form-group">
                    ...
                    <input type="text" readonly class="form-control font-size-16 form-mhealth"
                    value="{{ $data ? $data->pendarahan ? 'ada' : 'tidak ada' : '-' }}">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="keputihan" id="keputihan" class="form-control font-size-16 form-mhealth" style="height: 51px !important">
                        <option value="0" {{ $data ? $data->keputihan ? 'selected' : '' : '' }}>Tidak Ada</option>
                        <option value="1" {{ $data ? $data->keputihan ? 'selected' : '' : '' }}>Ada</option>
                    </select>
                </div>
					...
					@if ($data)
						@if ($data->keputihan)
							<div class="form-group">
								...
								class="form-control font-size-16 form-mhealth" value="{{ $data->keputihan_warna ?? '-' }}">
							</div>
						@endif
					@endif
                </div>
                <div class="form-group">
                    ...
                    <select name="keputihan_gatal" id="keputihan-gatal" class="form-control font-size-16 form-mhealth" style="height: 51px !important">
                        <option value="0"{{ $data ? $data->keputihan_gatal ? 'selected' : '' : '' }}>Tidak Gatal</option>
                        <option value="1"{{ $data ? $data->keputihan_gatal ? 'selected' : '' : '' }}>Gatal</option>
                    </select>
                </div>
                <div class="form-group">
                    <label for="">Mual</label>
                    <select name="mual" id="mual" class="form-control font-size-16 form-mhealth" style="height: 51px !important">
                        <option value="tidak mual" {{ $data ? $data->mual == 'tidak mual' ? 'selected' : '' : '' }}>Tidak Mual</option>
                        <option value="mual" {{ $data ? $data->mual == 'mual' ? 'selected' : '' : '' }}>Mual</option>
                        <option value="kadang-kadang" {{ $data ? $data->mual == 'kadang-kadang' ? 'selected' : '' : '' }}>Kadang-Kadang</option>
                        <option value="sering" {{ $data ? $data->mual == 'sering' ? 'selected' : '' : '' }}>Sering</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="pemakaian_obat" id="pemakaian_obat" class="form-control font-size-16 form-mhealth" style="height: 51px !important">
                        <option value="0"{{ $data ? $data->pemakaian_obat ? 'selected' : '' : '' }}>Tidak Pakai</option>
                        <option value="1"{{ $data ? $data->pemakaian_obat ? 'selected' : '' : '' }}>Pakai</option>
                    </select>
                </div>
                ...
                <div class="form-group">
					...
					value="{{ $data ? $data->keluhan_lainnya ?? '-'  : '-'}}">
                </div>
