		...
		<div class="col-12 shadow shadow-lg" style="height: 100%;">
			...
			<div class="text-center">
				<button type="button" class="btn btn-block btn-profile bg-white text-active-pink font-weight-500"
					onclick="openIdentity()">Identitas Anda</button>
				<button type="button" class="btn btn-block btn-profile bg-white text-active-pink font-weight-500"
				...
				<button type="button" class="btn btn-block btn-profile bg-white text-active-pink font-weight-500"
					...
					Kontrasepsi</button>
				<button type="button" class="btn btn-block btn-profile bg-white text-active-pink font-weight-500"
					onclick="openHistoryPrevPregnancy()">Riwayat Kehamilan Sebelumnya</button>
				<button type="button" class="btn btn-block btn-profile bg-white text-active-pink font-weight-500"
					onclick="openSocioeconomyHistory()">Riwayat Sosial Ekonomi</button>
				<button type="button" class="btn btn-block btn-profile bg-white text-active-pink font-weight-500"
					onclick="openFrame('{{ route('pasien.modal.health_history') }}', 'Riwayat Kesehatan')">Riwayat
					Kesehatan</button>
			</div>
		</div>
	</div>
...
<div class="container">
	<div class="card">
		<div class="card-body mb-29">
			<a href="#" onclick="openFrame('{{ route('pasien.profile.modal.password.change') }}', 'Edit Password')"
