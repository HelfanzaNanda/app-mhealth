...
return [
    ...
    */
    ...
    'DELHIVERY_APIKEY' => env('DELHIVERY_APIKEY', ''),
    ...
    'MAIL_VENDOR' => env('MAIL_VENDOR', 'elastic'),
    'TIMEOUT' => env('TIMEOUT',3600),
    'BILL_NUMBER_PREFIX' => env('BILL_NUMBER_PREFIX',date('ym').'.'),
    'PAYMENT_EXP_HOUR' => env('PAYMENT_EXP_HOUR','3')
];
